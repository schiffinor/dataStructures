 ...
 * have no effect on the map.  For example, invoking the {@link #putAll(CustomMap)}
...
public interface CustomMap<K, V> {
     ...
     */
    ArrayList<? extends CustomMap.Entry<K, V>> entrySet();
     ...
     * iterating the {@link CustomMap#entrySet} view of a map, either explicitly by using an
     ...
     * the {@link CustomMap.Entry#setValue setValue} method will be visible in the backing map.
     ...
     * such an Entry supports the optional {@link CustomMap.Entry#setValue setValue} method.
     * <p>
    ...
    interface Entry<K, V> {
        ...
        /**
         * Returns a comparator that compares {@link CustomMap.Entry} in natural order on key.
         *
         ...
         * @return a comparator that compares {@link CustomMap.Entry} in natural order on key.
         * @see Comparable
         * @since 1.8
         */
        ...
        /**
         * Returns a comparator that compares {@link CustomMap.Entry} in natural order on value.
         *
         * <p>The returned comparator is serializable and throws {@link
         ...
         * @return a comparator that compares {@link CustomMap.Entry} in natural order on value.
         * @see Comparable
         * @since 1.8
         */
        ...
        /**
         * Returns a comparator that compares {@link CustomMap.Entry} by key using the given
         * {@link Comparator}.
         *
        ...
        /**
         * Returns a comparator that compares {@link CustomMap.Entry} by value using the given
         * {@link Comparator}.
         *
         * <p>The returned comparator is serializable if the specified comparator
         * is also serializable.
