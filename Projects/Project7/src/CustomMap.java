...
public interface CustomMap<K, V> {
     ...
     */
    ArrayList<? extends Entry<K, V>> entrySet();
     ...
     * the {@link Entry#setValue setValue} method will be visible in the backing map.
     ...
     * such an Entry supports the optional {@link Entry#setValue setValue} method.
     * <p>
